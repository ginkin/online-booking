...
sum(
	...
	array('#sln-email_services', __('Email notification services', 'salon-booking-system')),
...
<div id="sln-salon_information" class="sln-box sln-box--main">
...
<div id="sln-date_time_settings" class="sln-box sln-box--main">
...
<div id="sln-assistant_selection" class="sln-box sln-box--main">
...
<div id="sln-email_services" class="sln-box sln-box--main">
...
<div id="sln-automatic_follow-up" class="sln-box sln-box--main">
...
<div id="sln-automatic_feedback_reminder" class="sln-box sln-box--main">
    <h2 class="sln-box-title"><?php _e('Automatic feedback reminder', 'salon-booking-system')?>
...
<div id="sln-administration_rules" class="sln-box sln-box--main">
    <h2 class="sln-box-title"><?php _e('Administration rules', 'salon-booking-system')?></h2>
    <div class="row">
