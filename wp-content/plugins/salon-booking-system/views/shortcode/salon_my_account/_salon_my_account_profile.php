...
$values       = array();
foreach (SLN_Enum_CheckoutFields::forCustomer() as $key => $field) {
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <?php 
                ...
                $width = $field['width'];
            ?>
                <div class="col-xs-12 col-md-<?php $width ?> <?php echo 'field-' . $key ?> <?php if ($type !== 'checkbox') {echo 'sln-input sln-input--simple';}?> <?php echo $type ? 'sln-' . $type : '' ?>">
